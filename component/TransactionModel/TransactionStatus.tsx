...
const TransactionStatusModal: React.FC<Props> = ({
    ...
    backdrop-blur-[6px]
    bg-[rgba(15_23_42_/_0.73)]
    flex items-center justify-center
    z-50
    p-[0.75rem]">
            <div className="  bg-[#f5f8fa]
    rounded-[12px]
    w-full max-w-[750px] max-h-[90vh]
    flex flex-col
   shadow-[0_8px_16px_rgba(0_0_0_/_0.2)]
    ...
    px-4 pt-4
             ">
                <div className="flex justify-between items-center">
                    ...
                    <button onClick={onClose} className=" w-9 h-9
    rounded-full
    bg-white
                ...
                <div className="p-xl overflow-y-auto mt-4 mb-4 flex-1">
                    <div className="flex flex-col gap-6">
                        {loading ? (
                            ...
                            <div className="border-b border-b-[#f5f8fa] pb-[0.75rem]">
                                <h4 className={styles.sectionTitle}>{data?.status ?? 'No status'}</h4>

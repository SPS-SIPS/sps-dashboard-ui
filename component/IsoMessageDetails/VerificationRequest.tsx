    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.details}>
                ...
                <div className={styles.statusContainer} style={{background: getStatusColor(isoMessage.status)}}>
                    <p className={styles.statusText}>{getTransactionStatusText(isoMessage.status)}</p>
                </div>
            ...
            <div className={styles.section}>
                ...
                <div className={styles.infoRow}>
                    ...
                    <span className={styles.value}>{displayValue(isoMessage.bizMsgIdr)}</span>
                </div>
                <div className={styles.infoRow}>
                    <span className={styles.label}>Message Definition ID:</span>
                    <span className={styles.value}>{displayValue(isoMessage.msgDefIdr)}</span>
                </div>
                <div className={styles.infoRow}>
            ...
            <div className={styles.section}>
                ...
                <div className={styles.infoRow}>
                    ...
                    <span className={styles.value}>{displayValue(isoMessage.endToEndId)}</span>
                </div>
                <div className={styles.infoRow}>
                    <span className={styles.label}>Reason:</span>
                    <span className={styles.value}>{displayValue(isoMessage.reason)}</span>
                </div>
                <div className={styles.infoRow}>
                    <span className={styles.label}>Additional Info:</span>
                    <span className={styles.value}>{displayValue(isoMessage.additionalInfo)}</span>
                </div>
            </div>
            ...
            <div className={styles.section}>
                ...
                <div className={styles.infoRow}>
                    <button
                        ...
                        onClick={() =>
                            setSelectedXml({content: isoMessage.request, title: `Request - ${isoMessage.msgId}`})
                        }
                    >
                ...
                <div className={styles.infoRow}>
                    <button
                        ...
                        onClick={() =>
                            setSelectedXml({content: isoMessage.response, title: `Response - ${isoMessage.msgId}`})
                        }
                    >

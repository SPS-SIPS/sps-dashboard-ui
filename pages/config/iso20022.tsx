...
import useConfigurationsISO20022, {
  ConfigurationsISO20022,
} from "../../api/hooks/useConfigurationsISO20022";
...
const ISO20022ConfigForm = () => {
  const { getConfigurations, updateConfigurations } =
    useConfigurationsISO20022();
        ...
        renderForm={(cfg, onChange) => (
          <div className={styles.section}>
            <Input
              ...
              name="verification"
              type="url"
              value={cfg.verification}
              onChange={onChange}
              placeholder="e.g. https://api.example.com/api/cb/verify"
            />
            <Input
              ...
              value={cfg.transfer}
              onChange={onChange}
              placeholder="e.g. https://api.example.com/api/CB/Transfer"
            />
            <Input
              label="Return Endpoint"
              name="return"
              type="url"
              value={cfg.return}
              onChange={onChange}
            ...
            <Input
              ...
              type="url"
              value={cfg.completionNotification}
              onChange={onChange}
              placeholder="e.g. http://api.example.com/api/CB/CompletionNotification"
            />
            <Input
              label="SIPS Endpoint"
              name="sips"
